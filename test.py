...
def main():
	...
	tweets['code'] = tweets['text'].apply(lambda tweet: word_in_text('code', tweet))
	tweets['relevant'] = tweets['text'].apply(lambda tweet: word_in_text('programming', tweet) or word_in_text('code', tweet))

	print tweets['programming'].value_counts()[True]
	print tweets['code'].value_counts()[True]
